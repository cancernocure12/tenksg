...
public class addcabin extends javax.swing.JFrame {
private cabinmanagement parent;
    
   public addcabin(cabinmanagement parent) {
    initComponents();
    this.parent = parent;
  ...
  String name = jTextField1.getText().trim();
    ...
    if (name.isEmpty() || description.isEmpty() || priceText.isEmpty() || capacityText.isEmpty()) {
    ...
    try {
        ...
        String sql = "INSERT INTO tbl_cabins (c_name, c_description, c_price, c_capacity, c_status) VALUES (?, ?, ?, ?, ?)";
        ...
        try (java.sql.Connection conn = config.config.connectDB();
            ...
            parent.loadCabins();   // refresh table
